...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    private com.example.mybanksystem.ViewHolder.ClickListener mClickListener;
    public interface  ClickListener{
        void onItemClick(View view, int position);
    }

    public void setOnClickListener(com.example.mybanksystem.ViewHolder.ClickListener clickListener){
