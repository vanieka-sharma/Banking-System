...
public class HistoryList extends AppCompatActivity {
    List<ListItem> modelList_historylist = new ArrayList<>();
    ...
    private void showData() {
        ...
        while (cursor.moveToNext()) {
           ...
           ListItem model = new ListItem(cursor.getString(2), cursor.getString(3), price, cursor.getString(1), cursor.getString(5));
